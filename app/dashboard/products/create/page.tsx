                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row justify-between gap-3">
                                ...
                                <div className="w-full">
                                    <Label>Offer Price (Optional, if offer price is not there then write 0)</Label>
                                    <Input
                                        key={fields.offerPrice?.key}
                                        name={fields.offerPrice?.name}
                                        defaultValue={fields.offerPrice?.initialValue}
                                        type="number"
                                        placeholder="&#x20b9; 50"
                                        onWheel={(e) => (e.target as HTMLInputElement).blur()}
                                    />
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Select
                                ...
                                defaultValue={fields.productCategories.initialValue}
                            >
                                <SelectTrigger>
