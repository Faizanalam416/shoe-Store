        ...
        <>
            <div className="my-10 mx-4">
                ...
                <ul className="list-disc list-outside ml-10 grid gap-y-4">
                    ...
                    <li>
                        <p className="tracking-tight text-justify">
                            <strong>Website</strong> refers to Shoe Store, accessible from{" "}
                            <a
                ...
                <ul className="list-disc list-outside ml-10 grid gap-y-4">
                    <li>
                        <p className="tracking-tight text-justify">Email address</p>
                    </li>
                    <li>
                        <p className="tracking-tight text-justify">Phone number</p>
                    </li>
                    <li>
                        <p className="tracking-tight text-justify">
                    ...
                    <li>
                        <p className="tracking-tight text-justify">Usage Data</p>
                    </li>
                </ul>
                <h4 className="text-xl my-6 tracking-tight font-semibold text-justify">
                    Usage Data
                ...
                <p className="mt-4 mb-1 tracking-tight text-justify">
                ...
                <ul className="list-disc list-outside ml-10 grid gap-y-4">
                    <li className="tracking-tight text-justify">
                        ...
                        <a
                            href="https://shoe-store-pied.vercel.app/contact"
                            rel="external nofollow noopener"
                            target="_blank"
                            className="text-blue-600 dark:text-blue-500 hover:underline"
                        >
                            https://shoe-store-pied.vercel.app/contact
                        </a>
                    </li>
                </ul>
            </div>
