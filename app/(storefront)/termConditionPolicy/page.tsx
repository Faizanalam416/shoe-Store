        ...
        <>
            <div className="my-10 mx-4">
                ...
                <p className="my-4 tracking-tight text-justify">
                    ...
                    <a
                        href="https://shoe-store-pied.vercel.app/"
                ...
                <ul className="list-disc list-outside ml-10 grid">
                    <li className="tracking-tight text-justify">Visa</li>
                    <li className="tracking-tight text-justify">Mastercard</li>
                    <li className="tracking-tight text-justify">PayPal</li>
                    <li className="tracking-tight text-justify">UPI</li>
                </ul>
                <p className="my-4 tracking-tight text-justify">
                ...
                <h2
                    className="text-3xl my-6 tracking-tight font-semibold text-justify"
                ...
                <p className="my-4 tracking-tight text-justify">
                    ...
                    Policy:{" "}
                    <a
                        href="https://shoe-store-pied.vercel.app/privacyPolicy"
                        rel="external nofollow noopener"
                        target="_blank"
                        className="text-blue-600 dark:text-blue-500 hover:underline"
                    >
                        https://shoe-store-pied.vercel.app/privacyPolicy
                    </a>
                ...
                <h2 className="text-3xl my-6 tracking-tight font-semibold text-justify" id="copyright_infringements">
                    COPYRIGHT INFRINGEMENTS
                </h2>
                <p className="my-4 tracking-tight text-justify">
                    We respect the intellectual property rights of others. If you believe
                ...
                <p className="my-4 tracking-tight text-justify">
                    ...
                    of India. New Samaj Store and yourself irrevocably consent that the
                ...
                <p className="my-4 tracking-tight text-justify">
                    ...
                    the jurisdiction of the India courts. New Samaj Store shall also
                ...
                <p className="tracking-tight text-justify">New Samaj Store</p>
                <p className="tracking-tight text-justify">
                    4FM9+G3R, Chandni Chowk, PHED Colony
                </p>
                <p className="tracking-tight text-justify">Araria, Bihar 854311</p>
                <p className="tracking-tight text-justify">India</p>
            </div>
        </>
    );
}
